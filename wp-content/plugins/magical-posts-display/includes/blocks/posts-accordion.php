...
?>
          <div class="card">
            ...
            <div class="card-header mgbaccordion-head z-depth-1 mb-1 p-0" role="tab" id="heading<?php echo esc_attr($rand_num.$count); ?>">
              <a class="mgbaccordion-title-link" data-toggle="collapse" data-parent="#mgpac<?php echo esc_attr($rand_num); ?>" href="#collapse<?php echo esc_attr($rand_num.$count); ?>" aria-expanded="<?php echo esc_attr($aria_ex); ?>" aria-controls="collapse<?php echo esc_attr($rand_num.$count); ?>">
                <div class="row">
                    <div class="col-md-11 col-sm-10"><<?php echo esc_attr($fields['mpdac_title_tag']); ?> class="m-0 white-text text-uppercase mgbaccordion-title text-<?php echo esc_attr($fields['mpdac_title_align']); ?>">
                  <?php echo wp_trim_words( get_the_title(), 20); ?>
                </<?php echo esc_attr($fields['mpdac_title_tag']); ?>></div>
            ...
            <!-- Card body -->
            <div id="collapse<?php echo esc_attr($rand_num.$count); ?>" class="collapse <?php echo esc_attr($aria_show); ?>" role="tabpanel" aria-labelledby="heading<?php echo esc_attr($rand_num.$count); ?>" data-parent="#mgpac<?php echo esc_attr($rand_num); ?>" style="">
              <div class="card-body mb-1 rgba-grey-light white-text mgba-content">
                  <?php echo wp_trim_words( get_the_content() , 80,'<a href="'.get_the_permalink().'" class="d-block mt-1">'.esc_html__(' Read More','magical-posts-display').'</a>'); ?>
