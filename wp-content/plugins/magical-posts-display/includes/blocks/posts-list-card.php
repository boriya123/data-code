...
<style type="text/css">
  ...
  .mgpdl<?php echo esc_attr($rand_num); ?> .mgpdl-card{
  ...
  .mgpdl<?php echo esc_attr($rand_num); ?> .mgpdl-card img,
  ...
  .mgpdl<?php echo esc_attr($rand_num); ?> .mgpdl-card .card-title a,
  ...
  .mgpdl<?php echo esc_attr($rand_num); ?> .mgpdl-card .card-text{
  ...
  .mgpdl<?php echo esc_attr($rand_num); ?> .mp-meta,
