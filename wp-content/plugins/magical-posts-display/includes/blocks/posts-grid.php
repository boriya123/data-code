...
<style type="text/css">
  <?php if($mpdg_cont_padding || $mpdg_cont_bgcolor): ?> 
  .mgpdg1<?php echo esc_attr($rand_num); ?> .mgpdg1-card{
    <?php if( $mpdg_cont_padding ): ?> 
    padding: <?php echo $mpdg_cont_padding; ?>px !important;
    <?php endif; ?> 
    <?php if( $mpdg_cont_bgcolor ): ?> 
    background: <?php echo $mpdg_cont_bgcolor; ?>;
    <?php endif; ?> 
  } 
  <?php endif; ?>  
  <?php if($mpdg_img_width || $mpdg_img_height || $mpdg_img_margin): ?> 
  .mgpdg1<?php echo esc_attr($rand_num); ?> .mgpdg1-card img,
  .mgpdg1<?php echo esc_attr($rand_num); ?> .mgpdg1-card .no-post-thumbnail{
    <?php if( $mpdg_img_width == 'yes'): ?> 
    width: 100%;
    <?php endif; ?> 
    <?php if( $mpdg_img_height ): ?> 
    height: <?php echo $mpdg_img_height; ?>px;
    <?php endif; ?> 
    <?php if( $mpdg_img_margin ): ?> 
    margin-bottom: <?php echo $mpdg_img_margin; ?>px;
    <?php endif; ?> 
  } 
  <?php endif; ?>   
  <?php if($mpdg_title_size || $mpdg_title_margin || $mpdg_title_color): ?> 
  .mgpdg1<?php echo esc_attr($rand_num); ?> .mgpdg1-card .card-title a,
  .mgpdg1<?php echo esc_attr($rand_num); ?> .mgpdg1-card .card-title{
    <?php if( $mpdg_title_size ): ?> 
    font-size: <?php echo $mpdg_title_size; ?>px;
    <?php endif; ?> 
    <?php if( $mpdg_title_color ): ?> 
    color: <?php echo $mpdg_title_color; ?>;
    <?php endif; ?> 
    <?php if( $mpdg_title_margin ): ?> 
    margin-bottom: <?php echo $mpdg_title_margin; ?>px;
    <?php endif; ?> 
  } 
  <?php endif; ?>   
  <?php if($mpdg_desc_size || $mpdg_desc_margin || $mpdg_desc_color): ?> 
  .mgpdg1<?php echo esc_attr($rand_num); ?> .mgpdg1-card .card-text{
    <?php if( $mpdg_desc_size ): ?> 
    font-size: <?php echo $mpdg_desc_size; ?>px;
    <?php endif; ?> 
    <?php if( $mpdg_desc_color ): ?> 
    color: <?php echo $mpdg_desc_color; ?>;
    <?php endif; ?> 
    <?php if( $mpdg_desc_margin ): ?> 
    margin-bottom: <?php echo $mpdg_desc_margin; ?>px;
    <?php endif; ?> 
  } 
  <?php endif; ?>  
  <?php if($mpdg_meta_size || $mpdg_meta_color ): ?> 
  .mgpdg1<?php echo esc_attr($rand_num); ?> .mp-meta,
  .mgpdg1<?php echo esc_attr($rand_num); ?> .mp-meta a,
  .mgpdg1<?php echo esc_attr($rand_num); ?> .mp-meta i{
    <?php if( $mpdg_meta_size ): ?> 
    font-size: <?php echo $mpdg_meta_size; ?>px;
    <?php endif; ?> 
    <?php if( $mpdg_meta_color ): ?> 
    color: <?php echo $mpdg_meta_color; ?>;
    <?php endif; ?> 
  } 
  <?php endif; ?>  
</style>
