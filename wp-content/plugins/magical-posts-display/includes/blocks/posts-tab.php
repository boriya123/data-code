...
<div class="tab mgpd-tab mgpdtab<?php echo esc_attr($rand_num); ?> mgpd-style1 mb-3" role="mgptab">
        ...
        <ul class="nav nav-tabs mgtnav text-<?php echo esc_attr($mpdtab_navtab_align); ?>" role="tablist">
            ...
            if($mgtab){
              ...
              ?>
                <li class="mgtnav-item"><a href="#mgcat<?php echo esc_attr($num.$rand_num); ?>" aria-controls="cat<?php echo esc_attr($num.$rand_num); ?>" role="tab" class="<?php if($num == 1): ?>active<?php else: ?>inactive<?php endif; ?>" data-toggle="tab"><?php echo esc_html($cat_name); ?></a></li>
            <?php endforeach; ?>
            <?php endif; ?>
    ...
    <div class="tab-content tabs pt-3 pb-3">
        <?php if($mpdtab_tabs): ?>
            ...
            $num++
              ?>
        <div role="mgptab" class="tab-pane mgpdtab1 <?php if($num == 1): ?>fade in active show<?php endif; ?>" id="mgcat<?php echo esc_attr($num.$rand_num); ?>">
