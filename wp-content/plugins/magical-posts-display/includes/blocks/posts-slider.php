...
<style type="text/css">
  <?php 
    mpd_get_style_item(
        '.mgps.mgp-slider.mgps'.esc_attr($rand_num).'  .mgps-item,.mgp-slider.mgps'.esc_attr($rand_num).' .mgps-item img',
        array(
            'height'=> $mpdsl_height,
        )
    );
    ...
    <div class="swiper-slide">
        ...
        <?php if($mpdsl_cat || $mpdsl_title || $mpdsl_desc || $mpdsl_show_btn ): ?>
            <div class="mgps-text text-<?php echo esc_attr($mpdsl_text_align); ?>">
                ...
                <?php endif; ?>
                <?php if($mpdsl_desc): ?>
                    <p class="mgps-desc" data-swiper-parallax="-200"><?php echo wp_trim_words( get_the_content(), 50 ); ?></p>
                <?php endif; ?>
                <?php if($mpdsl_show_btn): ?>
                    <a data-swiper-parallax="-600" href="<?php the_permalink(); ?>" class="btn btn-<?php echo esc_attr($mpdsl_btn); ?>"><?php echo esc_html($mpdsl_btn_text); ?></a>
                <?php endif; ?>
                </div>
            </div>
        <?php endif; ?>
