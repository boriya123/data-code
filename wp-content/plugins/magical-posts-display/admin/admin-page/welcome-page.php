...
<div id="mgpdp1" class="magical-post-display mgpdp1">
    <div class="mg-cols">
    	<section class="sec-wel" style="background-image: url(<?php echo MAGICAL_POSTS_DISPLAY_ASSETS; ?>img/blue.svg);">
    		<div class="wel-center-text">
    			...
    			<div class="wel-sect-text">
    				...
    				<a href="https://mpd.wpcolors.net/" class="button button-mgp1" target="_blank"><?php esc_html_e( 'View Demo', 'magical-post-display' ); ?></a>
    				<a href="#mgvideos" class="button button-mgp1 button-mgp2"><?php esc_html_e( 'Show video', 'magical-post-display' ); ?></a>
    			</div>
    	...
    	<section class="mgfeature mgf1">
    		<div class="cols">
    			...
    			<div class="col-2">
    				<div class="mgftext">
    					<h2><?php esc_html_e( 'Easy and Awesome WordPress Posts Display plugin', 'magical-post-display' ); ?></h2>
    					<p><?php esc_html_e( 'Now you can easily display your site posts many diffrent way. You can show your posts by posts carousel, posts grid, posts list grid, posts list, posts accordion, posts cateroty tab, So save your time and money.', 'magical-post-display' ); ?></p>
    				</div>
    			</div>
    		</div>
    	</section>
