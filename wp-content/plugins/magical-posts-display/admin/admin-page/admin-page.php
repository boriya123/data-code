...
class mgpDisplayWelcomePage {
    ...
    function admin_menu() {
        add_submenu_page( 'edit.php?post_type=mp-display', __('Welcome Page','magical-posts-display'), __('Welcome Page','magical-posts-display'), 'delete_posts', 'mgpd-welcome', array($this, 'plugin_page') );
    }
